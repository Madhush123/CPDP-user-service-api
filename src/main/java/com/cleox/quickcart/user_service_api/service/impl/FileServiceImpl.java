...
import com.cleox.quickcart.user_service_api.util.ImageUploadGenerator;
...
public class FileServiceImpl implements FileService {
    ...
    public CommonFileSavedBinaryDataDTO createResource(MultipartFile file, String directory, String bucket) {
       try {
           ...
           String newFileName=imageUploadGenerator.generateCleoxResourceName
    ...
    public byte[] downloadFile(String bucket, String fileName) {
        ...
        S3ObjectInputStream objectClient=object.getObjectContent();
        try {
            return IOUtils.toByteArray(objectClient);
        } catch (IOException e) {
            throw new RuntimeException(e);
        }
    }
